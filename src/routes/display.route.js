...
const displayController = __importStar(require("../controllers/display.controller"));
const router = (0, express_1.Router)();
router.get("/absensi/halaqah/:halaqahId", displayController.getPublicAbsensiByHalaqah);
